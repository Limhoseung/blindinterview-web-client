...
<head>
  ...
  <link href="https://github.com/lipis/bootstrap-social/blob/gh-pages/bootstrap-social.css" rel="stylesheet" type="text/css">
...
<body 
style="background-image: url('/images/resume1.jpg');background-repeat: no-repeat;background-size: contain"
id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage"><div data-text-content="true" style="font-weight: bold; font-size: 36px; color: rgb(255, 255, 255); font-family: &quot;Comic Sans MS&quot;;" spellcheck="false" class="">Blind Interview</div></a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#myPage">HOME</a></li>
        <li><a href="#mypage">SEEKER</a></li>
        <li><a href="#mypage">OFFER</a></li>
...
<div data-obj-id="n1zAp" data-obj-type="element" data-text-editable="true" class="" style="position: absolute; top: 384px; left: 84px; width: 422px; height: 50px;"><div data-text-content="true" style="font-weight: bold; font-size: 32px; color: rgb(255, 255, 255); font-family: &quot;Arial Black&quot;;" class="">Writing a Great Resume</div></div>
...
<div class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="paris.jpg" alt="QUICK">
       
        <p>스며들어 가는 열락의 소리다이것은 피어나기 전인 유소년에게서 구하지 못할 바이며 시들어 가는 노년에게서 구하지 못할 바이며 오직 우리 청춘에서만 구할 수 있는 것이다 청춘은 인생의 황금시대다</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="newyork.jpg" alt="EASY">
        
        <p>우리는 이 황금시대의 가치를 충분히 발휘하기스며들어 가는 열락의 소리다이것은 피어나기 전인 유소년에게서 구하지 못할 바이며 시들어 가는 노년에게서 구하지 못할 바이며 오직 우리 청춘에서만 구할 수 있는 것이다</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="sanfran.jpg" alt="FREE">
...
<footer class="text-center">
  ...
  <p>Blind Interview - Copyright © 2016 AHea. All rights reserved. </p>
</footer>
